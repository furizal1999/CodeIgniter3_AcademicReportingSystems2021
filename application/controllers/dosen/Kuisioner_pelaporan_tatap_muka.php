...
class Kuisioner_pelaporan_tatap_muka extends CI_Controller {
	...
	function __construct(){
		...
		$this->load->model('m_kuisioner_pelaporan_tatap_muka');
	}
	...
	public function index()
	{
		...
		$this->load->view('dosen/v_kuisioner_pelaporan_tatap_muka');
		$this->load->view('public/part/footer');
		unset($_SESSION['messege']);
	}

	function simpan_kuisioner(){
		if(isset($_POST['simpan_kuisioner_tm'])){
			...
			if($this->m_kuisioner_pelaporan_tatap_muka->simpan_kuisioner($status_login, $npk, $statement1, $statement2, $statement3, $statement4, $statement5, $statement6, $statement7, $statement8, $statement9, $statement10)){
				...
				redirect('dosen/kuisioner_pelaporan_tatap_muka');
			}else{
