					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							...
							<div class="ml-md-auto py-2 py-md-0">
								...
								<form class="" method="post" action="<?php echo base_url('tu/cetak_berita_acara_full') ?>" target='_BLANK'>
								...
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-md-12 bg-light rounded">
											<form action="<?php echo base_url('tu/berita_acara')?>" method="post">
												<div class="row">
													<div class="col-md-5">
								...
								<div class="table-responsive">
									<table class="table table-bordered table-striped" id="mydata" cellspacing="0" cellpadding="3" width="100%" style="width: 0px">
										...
										<?php 
											...
											?>
												<form class="" method="post" action="<?php echo base_url('tu/cetak_berita_acara/cetak/').$id_jadwal_lanjutan ?>" target='_BLANK'>
