					...
					<div class="row mt--2">
							...
							<div class="card full-height">
								<div class="card-body">
									<div class="col-md-6 bg-light rounded">
										<form action="<?php echo base_url('tu/matkul')?>" method="post">
											<div class="row">
												<div class="col-md-8">
						...
						<!-- ============ MODAL ADD =============== -->
								<div class="modal fade" id="modal_add_new" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
									...
									<form class="form-horizontal" method="post" action="<?php echo base_url('tu/matkul/tambah_matkul')?>">
							...
							<?php 
								...
								<div class="modal fade" id="modal_edit<?php echo $kode_mk;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
									...
									<form class="form-horizontal" method="post" action="<?php echo base_url().'tu/matkul/edit_matkul'?>">
										<div class="modal-body">
							...
							<!-- ============ MODAL HAPUS =============== -->
								<div class="modal fade" id="modal_hapus<?php echo $kode_mk;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
									...
									<form class="form-horizontal" method="post" action="<?php echo base_url().'tu/matkul/hapus_matkul'?>">
										<div class="modal-body">
