							...
							<div class="card full-height">
								<div class="card-body">
									<div class="row">
										<div class="col-md-6 bg-light rounded">
											<form action="<?php echo base_url('upm/preview_laporan_pertemuan')?>" method="post">
												<div class="row">
													<div class="col-md-8">
								...
								<?php if(isset($_SESSION['id_pertemuan_search'])){ ?>
									<div class="table-responsive">
										<table id="dataPreviewLaporanPertemuanPadaAksesUPM" class="table table-bordered table-striped"  cellspacing="0" cellpadding="3" width="100%" style="width: 0px">
											<thead>
												<tr  class="bg-success">
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#dataPreviewLaporanPertemuanPadaAksesUPM').DataTable( {
			"processing": true,
			"serverSide": true,
			"paging": true,
	        "lengthChange": true,
	      ...
	      //   "columnDefs": [ {
							...
							// } ],
			"ajax":{
				url :"<?= base_url('upm/preview_laporan_pertemuan/get_ajax');?>",
				type: "post",
				error: function(){
					$(".dataPreviewLaporanPertemuanPadaAksesUPM-error").html("");
					$("#dataPreviewLaporanPertemuanPadaAksesUPM").append('<tbody class="dataPreviewLaporanPertemuanPadaAksesUPM-error"><tr><th colspan="3">Tidak ada data untuk ditampilkan</th></tr></tbody>');
					$("#dataPreviewLaporanPertemuanPadaAksesUPM-error-proses").css("display","none");
