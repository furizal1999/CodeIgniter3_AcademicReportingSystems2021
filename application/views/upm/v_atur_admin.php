				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h1 class="text-white pb-2 fw-bold">DAFTAR ADMIN UPM</h1>
								<h5 class="text-white op-7 mb-2">Fakultas Teknik Universitas Islam Riau</h5>
							</div>
							<div class="ml-md-auto py-2 py-md-0">
								<h1 align="right">
									<a class="text-white border-white custom-btn bg-primary btn mt-3" data-toggle="modal" data-target="#modal_add_new"><i class="fa fa-plus"></i> Tambah Admin UPM</a>		
								</h1>
                            </div>
						</div>
					</div>
									...
									<table class="table table-bordered table-striped" id="mydata" cellspacing="0" cellpadding="3" width="100%" style="width: 0px">
										<thead>
											<tr  class="bg-info">
												...
												<td align="center"><b>HAK AKSES</b></td>
						...
						<!-- ============ MODAL ADD =============== -->
								<div class="modal fade" id="modal_add_new" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
									...
									<div class="modal-header bg-primary text-white">
										<h3 class="modal-title" id="myModalLabel">Tambah Admin UPM</h3>
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
									</div>
									<form class="form-horizontal" method="post" action="<?php echo base_url('upm/atur_admin/tambah_admin')?>">
							...
							<?php 
								...
								<div class="modal fade" id="modal_edit<?php echo $username;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
									...
									<div class="modal-header bg-secondary text-white">
										<h3 class="modal-title" id="myModalLabel">Edit Admin UPM</h3>
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
									</div>
										<form class="form-horizontal" method="post" action="<?php echo base_url('upm/atur_admin/edit_admin')?>">
											<div class="modal-body">
							...
							<!-- ============ MODAL HAPUS =============== -->
								<div class="modal fade" id="modal_hapus<?php echo $username;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
									...
									<div class="modal-header bg-danger">
										<h3 class="modal-title" id="myModalLabel">Hapus Admin UPM</h3>
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
									</div>
									<form class="form-horizontal" method="post" action="<?php echo base_url().'upm/atur_admin/hapus_admin'?>">
										<div class="modal-body">
							...
							<!-- ============ MODAL AKTIFKAN =============== -->
								<div class="modal fade" id="modal_aktifkan<?php echo $username;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
									...
									<div class="modal-header bg-success">
										<h3 class="modal-title" id="myModalLabel">Aktifkan Admin UPM</h3>
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
									</div>
									<form class="form-horizontal" method="post" action="<?php echo base_url().'upm/atur_admin/aktifkan_admin'?>">
										<div class="modal-body">
							...
							<!-- ============ NONAKTIFKAN ADMIN =============== -->
								<div class="modal fade" id="modal_nonaktifkan<?php echo $username;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
									...
									<div class="modal-header bg-warning">
										<h3 class="modal-title" id="myModalLabel">Non-aktifkan Admin UPM</h3>
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
									</div>
									<form class="form-horizontal" method="post" action="<?php echo base_url().'upm/atur_admin/nonaktifkan_admin'?>">
										<div class="modal-body">
