						...
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							...
							<div align="right" class="ml-md-auto m-1">
								<?php if(isset($_SESSION['id_ujian_search'])){ ?>
									<form class="" method="post" action="<?php echo base_url('upm/rekapitulasi/cetak/'.$_SESSION['id_ujian_search']) ?>" target='_BLANK'>
							...
							<div class="card full-height">
								...
								<div class="card-body">
									<div class="col-md-10 bg-light rounded">
										<form action="<?php echo base_url('upm/rekapitulasi')?>" method="post">
											<div class="row">
												<div class="col-md-8">
