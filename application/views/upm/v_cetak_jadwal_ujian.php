...
<html lang="en">
    ...
    ?>
                    <div>
                        ...
                        <div style="text-align:center; padding-bottom: 5px"><b>PROGRAM STUDI <?php echo strtoupper($this->m_cetak_jadwal->ambil_nama_prodi($_SESSION['kode_prodi'])).' FAKULTAS TEKNIK'; ?></b></div>
                    ...
                    ?>
                     ...
                     <table style="font-size: 14 ;">
                        ...
                        <tr>
                            ...
                            <td width="100px">.</td>
                            <td width="300px" style="text-align: left;">Ka.Prodi <?php echo $this->m_cetak_jadwal->ambil_nama_prodi($_SESSION['kode_prodi']) ?></td>
