										...
										?>
											<tr>
												...
												?>
													...
													<td align="center">
														<div class="btn-group">
															<?php if(($this->m_preview_laporan_pertemuan->cekTtdWd1($id_jadwal_kelas_pertemuan)<1) && ($this->m_preview_laporan_pertemuan->cekTtdKetuaProdi($id_jadwal_kelas_pertemuan)>0)){ ?>
																<a class="text-white btn btn-secondary btn-sm inline" target="_BLANK" data-toggle="modal" data-target="#modalTddWd1<?= $id_jadwal_kelas_pertemuan?>"> <i class="fas fa-pen"></i> Tandatangani</a>
															<?php } ?>
															<a class="btn btn-warning btn-sm inline" target="_BLANK" href="<?= base_url('fakultas/preview_laporan_pertemuan/cetak_laporan_pertemuan/'.$id_jadwal_kelas_pertemuan) ?>"> <i class="fas fa-print"></i> Cetak</a>
														</div>
													</td>
													...
													<div class="modal fade" id="modalDetail<?php echo $id_presensi_pertemuan; ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<form class="form-horizontal" method="post" action="<?php echo base_url().'fakultas/preview_laporan_pertemuan/presensi'?>" enctype="multipart/form-data">
											...
											?>
												...
												<!-- MODAL TANDA TANGAN -->
												<div class="modal fade" id="modalTddWd1<?php echo $id_jadwal_kelas_pertemuan; ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<form class="form-horizontal" method="post" action="<?php echo base_url().'fakultas/preview_laporan_pertemuan/insertTddWd1'?>" enctype="multipart/form-data">
																<div class="modal-body">
