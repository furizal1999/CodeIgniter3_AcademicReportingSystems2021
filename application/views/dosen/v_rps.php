							...
							<div class="card full-height">
								...
								<div class="row">
										<div class="col-md-6 bg-light rounded">
											<form action="<?php echo base_url('dosen/rps')?>" method="post">
												<div class="row">
													<div class="col-md-8">
								...
								<?php if(isset($_SESSION['id_pertemuan_search'])){ ?>
										<a class="text-white border-white custom-btn bg-primary btn" data-toggle="modal" data-target="#modal_add_new"><i class="fa fa-upload"></i> Upload RPS</a>
									<hr>
								<?php } ?>
						...
						<!-- ============ MODAL ADD =============== -->
								<div class="modal fade" id="modal_add_new" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
									...
									<div class="modal-header bg-primary text-white">
										<h3 class="modal-title" id="myModalLabel">Upload RPS</h3>
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
									</div>
									<form class="form-horizontal" method="post" action="<?php echo base_url().'dosen/rps/upload'?>" enctype="multipart/form-data">
											<div class="modal-body">
												<div class="form-group">
													<div class="col-xs-8 form-group">
														<label class="control-label col-xs-3" >KELAS MATAKULIAH (Boleh lebih dari 1)</label><br>
															...
															<?php
																foreach($combobox_kelas_matkul->result_array() as $i):
																	...
																	if($this->m_rps->cekKetersediaanBerkasKontrakKuliah($id_jadwal_kelas_pertemuan_combo)==0){


															?>
															<input type="checkbox" name="id_jadwal_kelas_pertemuan[]" value="<?php echo $id_jadwal_kelas_pertemuan_combo ?>"> <?php echo $nama_mk_combo.' ('.$nama_kelas_combo.')'; ?> <br>
											...
											<div class="modal-footer">
												...
												<button class="btn btn-primary" name="upload_rps">Upload Sekarang</button>
											</div>
										</form>
									</div>
									</div>
							...
							<!-- ============ MODAL HAPUS =============== -->
								<div class="modal fade" id="modal_hapus<?php echo $id_berkas_pertemuan;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
									...
									<div class="modal-header bg-danger">
										<h3 class="modal-title" id="myModalLabel">Hapus Berkas RPS</h3>
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
									</div>
									<form class="form-horizontal" method="post" action="<?php echo base_url().'dosen/rps/hapus_berkas'?>">
										<div class="modal-body">
											<p>Anda yakin ingin menghapus berkas RPS untuk matkul <b><?php echo $nama_mk;?></b> pada kelas <b><?php echo $nama_kelas;?></b> ini?</p>
										</div>
										<div class="modal-footer">
											...
											<button class="btn" data-dismiss="modal" aria-hidden="true">Tutup</button>
											<button class="btn btn-danger" name="hapus_berkas_rps">Hapus</button>
										</div>
									</form>
									</div>
									</div>
