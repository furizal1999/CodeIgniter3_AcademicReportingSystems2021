										...
										<div class="col-md-6 bg-light rounded">
											<form action="<?php echo base_url('dosen/presensi_pertemuan')?>" method="post">
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group text-left">
															<label class="control-label col-xs-3" >SK Pengasuh</label>
													...
													<td align="center" class="<?php echo $warna ?>">
														...
														<?php if(($pertemuan_mulai<=$jadwalAwal.' '.$jadwalAwalJam) && ($pertemuan_selesai>=$jadwalAwal.' '.$jadwalAwalJam)){ ?>
														  ...
														  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
														  	...
														  	<?php 	;
															      	if($this->m_presensi_pertemuan->cekPertemuanSebelumnya($id_jadwal_kelas_pertemuan,$i)== 1 || $tulisan_ujian=="UTS" || $tulisan_ujian=="UAS"){ ?>
														  			<?php if($yesterday==$today || $jadwalAwal<$now){?>
																	  	...
																	  	<?php }elseif(($jadwalAwal==$now) || (($this->m_presensi_pertemuan->cekRequestPertemuanDisetujui($id_jadwal_kelas_pertemuan, ($i+1))->num_rows()>0)) || $tulisan_ujian=="UAS"){ ?>
																	  		<?php
																	  			...
																	  			if((($jadwalAwal==$now) || ($tanggal_diaju==$now) || $tulisan_ujian=="UTS" || $tulisan_ujian=="UAS")){
																					if(((($i+1)>8) && $this->m_presensi_pertemuan->cekPertemuanSebelumnya($id_jadwal_kelas_pertemuan, 7)== 1) || $tulisan_ujian=="UTS" || $tulisan_ujian=="UAS" || ($tanggal_diaju==$now) || $jadwalAwal==$now){
																						//presensi
																			?>
