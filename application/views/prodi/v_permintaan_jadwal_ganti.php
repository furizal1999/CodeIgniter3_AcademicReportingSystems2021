				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h1 class="text-white pb-2 fw-bold">PERMINTAAN PERSETUJUAN JADWAL GANTI</h1>
							...
							<div class="card full-height">
								<div class="card-body">
									<div class="row">
										<div class="col-md-6 bg-light rounded">
											<form action="<?php echo base_url('prodi/permintaan_jadwal_ganti')?>" method="post">
												<div class="row">
													<div class="col-md-8">
								...
								<?php if(isset($_SESSION['id_pertemuan_search'])){ ?>
									<div class="table-responsive">
										<table id="dataPermintaanJadwalGanti" class="table table-bordered table-striped"  cellspacing="0" cellpadding="3" width="100%" style="width: 0px">
											<thead>
												<tr  class="bg-info">
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#dataPermintaanJadwalGanti').DataTable( {
			"processing": true,
			"serverSide": true,
			"paging": true,
	        "lengthChange": true,
	      ...
	      //   "columnDefs": [ {
							...
							// } ],
			"ajax":{
				url :"<?= base_url('prodi/permintaan_jadwal_ganti/get_ajax');?>",
				type: "post",
				error: function(){
					$(".dataPermintaanJadwalGanti-error").html("");
					$("#dataPermintaanJadwalGanti").append('<tbody class="dataPermintaanJadwalGanti-error"><tr><th colspan="3">Tidak ada data untuk ditampilkan</th></tr></tbody>');
					$("#dataPermintaanJadwalGanti-error-proses").css("display","none");
