							...
							<div class="card full-height">
								...
								<?php if(isset($_SESSION['id_pertemuan_search'])){ ?>
									...
									<div class="table-responsive">
										<table id="dataPreviewLaporanPertemuanPadaAksesProdi" class="table table-bordered table-striped"  cellspacing="0" cellpadding="3" width="100%" style="width: 0px">
											<thead>
												<tr  class="bg-success">
...
<script type="text/javascript" language="javascript" >
	...
	$(document).ready(function() {
		var dataTable = $('#dataPreviewLaporanPertemuanPadaAksesProdi').DataTable( {
			"processing": true,
			"serverSide": true,
			"paging": true,
	        "lengthChange": true,
	      ...
	      //   "columnDefs": [ {
							...
							// } ],
			"ajax":{
				url :"<?= base_url('prodi/preview_laporan_pertemuan/get_ajax');?>",
				type: "post",
				error: function(){
					$(".dataPreviewLaporanPertemuanPadaAksesProdi-error").html("");
					$("#dataPreviewLaporanPertemuanPadaAksesProdi").append('<tbody class="dataPreviewLaporanPertemuanPadaAksesProdi-error"><tr><th colspan="3">Tidak ada data untuk ditampilkan</th></tr></tbody>');
					$("#dataPreviewLaporanPertemuanPadaAksesProdi-error-proses").css("display","none");
