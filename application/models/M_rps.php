...
class M_rps extends CI_Model{
	...
	function show_berkas_pertemuan($id_pertemuan, $kode_jurusan, $npk){
		$query = $this->db->query("
			...
			tb_berkas_pertemuan.nama_berkas = 'RPS'
	...
	function upload($id_jadwal_kelas_pertemuan, $berkasbaru){
		...
		$hasil=$this->db->query("INSERT INTO tb_berkas_pertemuan (id_jadwal_kelas_pertemuan, nama_berkas, nama_file_berkas, waktu_upload_berkas_pertemuan, status) VALUES ($id_jadwal_kelas_pertemuan, 'RPS', '$berkasbaru', '$waktu_input', 'Tersedia')");
		return $hasil;
	}
	...
	function cekKetersediaanBerkasKontrakKuliah($id_jadwal_kelas_pertemuan){
		$sql = "SELECT * FROM tb_berkas_pertemuan WHERE id_jadwal_kelas_pertemuan='$id_jadwal_kelas_pertemuan' AND nama_berkas='RPS' AND status='Tersedia'";
